class Hotel {
  ...
  static List<Hotel> hotellist() {
    return [
      Hotel(
          'assets/images/empyrean.jpg',
          'Empyrean Hotel',
          'Boasting a fitness centre, shared lounge and views of city, Empyrean Hotel is set in Dhaka, 1.7 km from Bangladesh University of Textiles. Among the facilities of this property are a restaurant, a 24-hour front desk and room service, along with free WiFi throughout the property. The accommodation offers an ATM, a concierge service and currency exchange for guests.',
          "Dhaka",
          10500,
          4.3),
      Hotel(
          ...
          'InterContinental',
          'Located in the prestigious downtown business district, InterContinental Dhaka is the foremost name of luxury. The hotel is beautifully designed boasted with Millennium modern outlook with a touch of local culture. Featuring 226 luxury rooms and suites, a selection of restaurants offering exquisite cuisines. Host your events at the meeting spaces equipped with modern facilities. ',
          "Dhaka",
          11990,
          4.4),
      Hotel(
          'assets/images/panpacific.jpg',
          ...
          4.3),
      Hotel(
          'assets/images/seapearl.jpg',
          'Sea Pearl Beach Resort',
          "Sea Pearl Beach Resort & Spa is located on Inani beach, Cox's Bazar with lush green hills rise from the east and endless sea stretching on the west, the resort offers panoramic visuals of Bay of Bengal. Nestled in the heart of nature along the world’s longest natural sandy beach, the resort is spread over 15 acres",
          "Cox's Bazar",
          15000,
          4.3),
      Hotel(
          'assets/images/thewestin.jpg',
          'The Westin',
          'Conveniently placed just 8 km away from Hazrat Shahjalal International Airport, The Westin Dhaka boasts a spacious swimming pool and offers free Wi-Fi at all areas. It also houses 5 restaurants.Located just 1 km away from Shopper’s World Mall, the property is also a 8 km away from the historical Bahadur Shah Park Memorial.',
          "Dhaka",
          10400,
          4.2),
      Hotel(
          'assets/images/sixseason.png',
          'Six Season',
          ...
          4.1),
      Hotel(
          'assets/images/radisondhaka.png',
  ...
  static List<Hotel> PeoplechoiceList() {
    return [
      Hotel(
          'assets/images/radisonbluchittagong.webp',
          'Raddison Blu',
          "As the city’s premier international hotel, the Radisson Blu Chattogram Bay View offers you an unforgettable stay with spectacular views of Chattogram, the Bay of Bengal, and the Hill Tracts. Enjoy posh rooms and suites within walking distance of M. A. Aziz Stadium and landmarks like the Circuit House in this commercial capital. The hotel is just a 10-minute drive from the city’s main business hub and less than 45 minutes from Shah Amanat International Airport",
          "Chittagong",
          16500,
          4.5),
      Hotel(
          'assets/images/renaissance.webp',
          'Renaissance',
          "Conveniently located in the most dynamic and inspiring neighborhood of Gulshan, Renaissance Dhaka Gulshan Hotel is ideal for business and leisure travelers alike. Enjoy easy access to the Hazrat Shahjalal International Airport, just 20 minutes away, and experience the distinctive local character that dictates the atmosphere and experiences for guests. Discover sophisticated elements and uber design throughout the 211 stylish rooms and suites. The infinity rooftop temperature-controlled pool with a stunning city vista view will take your breath away",
          "Dhaka",
          13000,
          4.2),
      Hotel(
          'assets/images/soangaonroyal.png',
          'Sonargaon Royal',
          "Welcome to Sonargaon Royal ResortWe welcome you to our resort as you enlighten our abode with your warmth and smiley nature. We are truly grateful to you for your visit here and hope to have memorable moments throughout your visit.",
          "Dhaka",
          10500,
          4.1),
      Hotel(
          'assets/images/hotelgrandpark.png',
          'Hotel Grand Park',
